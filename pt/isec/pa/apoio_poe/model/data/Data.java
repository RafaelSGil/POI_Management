...
public class Data{
    ...
    public boolean addStudent(String name, String email, long id, String course, String courseBranch, double classification, boolean internship){
        ...
        return persons.get("students").add((Student.createStudent(name, email, id, course, courseBranch, classification, internship)));
    }
    ...
    public boolean addInternship(String idOfProposal, String title, Student student, String branch, String nameOfCompany){
        ...
        return proposals.get("internships").add(Internship.createInternship(idOfProposal, title, student, branch, nameOfCompany));
    }
    ...
    public String getStudentGivenItsID(long idOfStudent){
        ...
        return persons.get("students").get(persons.get("students").indexOf(Student.createDummyStudent(idOfStudent))).toString();
    }
    ...
    public String getProfessorGivenItsEmail(String email){
        ...
        return persons.get("professors").get(persons.get("professors").indexOf(Professor.createDummyProfessor(email))).toString();
    }
    ...
    public boolean removeInternshipsGivenItsID(String idOfProposal){
        if(idOfProposal == null){return false;}
